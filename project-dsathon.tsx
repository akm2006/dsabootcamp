...
const gradientStyle = {
  body: {
    background: "linear-gradient(-45deg, rgba(56, 189, 248, 0.18), rgba(34, 211, 238, 0.18), rgba(102, 232, 181, 0.12), rgba(16, 185, 129, 0.12))",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-green-50 to-white flex flex-col items-center justify-center">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-b text-center from-blue-900 to-blue-600 bg-clip-text text-transparent mb-6 animate-fade-in drop-shadow-lg hover:scale-105 transition-transform [text-shadow:_4px_4px_8px_rgba(0,0,0,0.3)]">
              JOIN US ON DSA-THON
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-all duration-300 transform hover:scale-105 border-2 border-green-200">
                ...
                <p className="text-gray-600 text-lg">
                  Build a strong DSA foundation, making it easier to transition
                  to advanced topics and interview prep.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="setup"
          className="py-20 px-4 bg-gradient-to-br from-emerald-50 to-white"
        >
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-b text-center from-blue-900 to-blue-600 text-transparent bg-clip-text  mb-12 text-center animate-fade-in drop-shadow-lg hover:scale-105 transition-transform [text-shadow:_4px_4px_8px_rgba(0,0,0,0.3)]">
              Prerequisites & Setup
            </h2>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-b text-center from-blue-900 to-blue-600 text-transparent bg-clip-text mb-6 animate-fade-in drop-shadow-md hover:scale-105 transition-transform [text-shadow:_2px_2px_4px_rgba(0,0,0,0.2)] text-center">
              Pre-requisite Resources
            </h2>
            <p className="text-lg text-gray-600 text-center mb-12">
              Essential learning materials and video tutorials to help you
            ...
            <div className="grid grid-cols-1 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-2 border-green-200">
                ...
                <a
                  href="https://www.youtube.com/watch?v=EAR7De6Goz4&t=250s"
                  className="inline-block text-green-600 hover:text-green-700 text-lg font-semibold hover:underline"
                  target="_blank"
                >
                  Watch Video →
                </a>
              ...
              <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-2 border-green-200">
                ...
                <a
                  href="https://www.youtube.com/watch?v=rlZpZ8es_6k&list=PLqM7alHXFySF7JxK9E24C-ZeNAXFB1u8k"
                  className="inline-block text-green-600 hover:text-green-700 text-lg font-semibold hover:underline"
                  target="_blank"
                >
                  Watch Video →
              ...
              <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border-2 border-green-200">
                ...
                <a
                  href="https://www.youtube.com/watch?v=jOMxKsUd6e0"
                  className="inline-block text-green-600 hover:text-green-700 text-lg font-semibold hover:underline"
                  target="_blank"
                >
                  Watch Video →
